...
# Examples :scroll:
 - To view the test results, navigate to the "report" folder and open the test result report file in a web browser. This report is automatically generated after running the tests. It contains all the necessary logs and details regarding the test execution..
...
<img width="1461" alt="image" src="https://github.com/satyricon77/teststore/assets/90909315/9aa56990-96f4-4ff8-9f14-ab0d4579cecc">
 ...
 - The project utilizes the default Selenide logger mechanism, enabling you to observe test logs directly in the console.
